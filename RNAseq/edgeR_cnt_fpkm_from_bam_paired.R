...
#do featureCounts
sink(file="featurecounts_log.txt")
fc <- featureCounts(files=inputs,annot.ext="/netscratch/dep_psl/grp_rgo/taklee/genomes/Hvulgare/GP/concat_Plecuc1pilon_HvGP_BPGv2/HvGPBPGv2_Plecuc1polished.gtf",isGTFAnnotationFile = TRUE,GTF.featureType = "exon",GTF.attrType = "gene_id",nthreads=args[1],isPairedEnd=TRUE)
